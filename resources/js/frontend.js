...
import './plugins/jquery.countup';
import './plugins/tilt.jquery';
import './plugins/mobile-meanmenu';
import './plugins/jquery.lineProgressbar';

// Slick Slider
import 'slick-slider/slick/slick.js';

import 'modal-video/js/modal-video.min.js';
        ...
        $(canvas)
            ...
            .animate(
                ...
                $.extend({}, options.animation, {
                    step: function (p) {
                        _draw(p);
                        $(canvas).trigger('circle-animation-progress', [
                            p / v,
                            p,
                        ]);
                    },
