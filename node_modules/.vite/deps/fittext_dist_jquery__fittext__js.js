...
$.fn.fitText = function(maxFontSize, language) {
  ...
  var getTextSize = function() {
    if (!$.fn.fitText.fakeEl) {
      $.fn.fitText.fakeEl = $("<div></div>").width(container.width()).height(container.height()).appendTo($("body")).css("visibility", "hidden");
...
//# sourceMappingURL=fittext_dist_jquery__fittext__js.js.map
